  ...
  <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
	     <tr bgcolor="#DFE1EC">
		    ...
		    <td width="28%"><input type="text" size="40" name="deptSelect" autocomplete="off"/></td>
		    <td width="12%" class="en11pxb" bgcolor="#ACD5C9">物料号:</td>
           <td width="28%"><input class="input" type="text" name="partNo" id="partNo" /></td>
	    </tr>
	    <tr bgcolor="#DFE1EC">
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr height="30">
    <td><ul class="button">
    <li><a class="button-text" href="javascript:doSubmit('<%=request.getContextPath()%>/control/pmPartsUsedDetailQuery')"><span>&nbsp;查询&nbsp;</span></a></li>
    </ul></td>
    <td width="20">&nbsp;</td>
  </tr>
</table>
  ...
  <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
        <tr bgcolor="#ACD5C9">
          ...
          <td width="20%" class="en11pxb">物料描述</td>
          <td width="5%" class="en11pxb">单价</td>
          <td width="7%" class="en11pxb">理论用量</td>
          <td width="8%" class="en11pxb">实际用量</td>
          <td width="10%" class="en11pxb">实际与理论差异</td>
        </tr>
       <% if(partList != null && partList.size() > 0) {
       		for(Iterator it = partList.iterator();it.hasNext();) {
					Map map = (Map)it.next();
					double diff = Double.valueOf((String)map.get("COUNT_DIFF"));
	    ...
	    %>
		        <tr bgcolor="#DFE1EC">
		          ...
		          <td class="en11px"><%=UtilFormatOut.checkNull((String)map.get("PART_COUNT"))%></td>
		          <td class="en11px"><%=UtilFormatOut.checkNull((String)map.get("USED"))%></td>
		          <td class="en11px" style="color: <%=color%>;"><%=UtilFormatOut.checkNull((String)map.get("COUNT_DIFF"))%></td>
		        </tr>
	  <%
	  	}
	  } %>
