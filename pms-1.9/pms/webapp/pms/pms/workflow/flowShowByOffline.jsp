...
//	GenericDelegator delegator = CommonUtil.getPmsDelegator(request);
	...
	Job job = null;
	try {
		job = support.parseJobRelation(jobRelationIndex, delegator);
	} catch(Exception e) {
  ...
  <td><fieldset>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
    	...
    	<tr bgcolor="#ACD5C9">
      		...
      		<td width="80%" bgcolor="#DFE1EC" class="en11pxb"><%=job.getJobDescription()%></td>
    	</tr>
      </table>
      </fieldset></td>
  </tr>
		        ...
		        <tr>
		            <td width="33%">
		                <table cellpadding="3" cellspacing="3">
		                	...
		                	<tr>
		                		<td align="center" nowrap><img src="../css/arrow_down_blue.gif" height=16 width=16 border=0 align=absmiddle></td>
		                	</tr>
		                	<% }
		                	  }
		                	} %>
