...
Ext.extend(Ext.DateTimePicker, Ext.Component, {
    ...
    onRender : function(container, position){
        ...
        var tdsecond = this.el.child("td.x-date-second");
        tdsecond.appendChild(this.secondel);
    	for(var i=0;i<60;i++){
    ...
    selectToday : function(){
        ...
        this.fireEvent("select", this, new Date());
    },

    
    update : function(date){
    	date.setHours(this.hourel.options[this.hourel.selectedIndex].value);
    	date.setMinutes(this.minuteel.options[this.minuteel.selectedIndex].value);
    	date.setSeconds(this.secondel.options[this.secondel.selectedIndex].value);
        var vd = this.activeDate;
        this.activeDate = date;
