...
{
	loading();
    document.pcScheduleForm.action = "<%=request.getContextPath()%>/control/pcScheduleDefine?periodIndex="+obj.value;
...
{	
	loading();
	document.pcScheduleForm.action = "<%=request.getContextPath()%>/control/pcScheduleDefine";
    document.pcScheduleForm.submit();
}
...
{	
	loading();
	if (document.pcScheduleForm.form_pcsetup.checked)
	{
		document.pcScheduleForm.flag.value="1";
	}
		
	document.pcScheduleForm.action = "<%=request.getContextPath()%>/control/pcScheduleAdd";
...
function dayClear()
{
	...
	document.pcScheduleForm.action = "<%=request.getContextPath()%>/control/pcScheduleClear";	
	document.pcScheduleForm.submit();
}
</script>
<%
