...
<form action="<%=request.getContextPath()%>/control/submitPmDelete" method="post" id="pmForm" onsubmit="return false;">
...
<input type="hidden" name="eqpId" id="eqpId" value='<%=paramMap.get("eqpId")%>'>
