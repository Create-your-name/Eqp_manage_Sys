...
<form name="pcForm" method="post" action="<%=request.getContextPath()%>/control/newQueryPcFormEntry">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		%>
			        <tr bgcolor="#DFE1EC">
			        	...
			        	<td class="en11px">
			        	    <a href="javascript:document.location.href=encodeURI('newInputPcFormEntry?periodName=<%=periodName%>&pcIndex=<%=pcIndex%>&jobRelationIndex=<%=jobRelationIndex%>&status=<%=status%>')">
			        	        <%=pcName%>
			        	    </a>
			        	 </td>
