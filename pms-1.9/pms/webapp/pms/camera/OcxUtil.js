...
function StartCamYUV(CamID, width, height) {
  if (isIE) {
...
function StartCam2YUV(CamID, width, height) {
  if (isIE) {
...
function CombineTwoImageBase64(ImgPath1, ImgPath2, dir) {
  if (isIE) {
...
function CombineTwoImageInside(combinePath, ImgPath1, ImgPath2, xoff, yoff) {
  if (isIE) {
    var ret = axCam_Ocx.CombineTwoImageInside(
      combinePath,
      ImgPath1,
      ImgPath2,
      xoff,
...
function CombineTwoImageInsideBase64(ImgPath1, ImgPath2, xoff, yoff) {
  if (isIE) {
    var ret = axCam_Ocx.CombineTwoImageInsideBase64(
      ImgPath1,
      ImgPath2,
      xoff,
      yoff
...
function OpenWaterMark(waterinfo, FontSize, FontSytle, r, g, b, xOff, yOff) {
  if (isIE) {
...
function AddFingerBase64(fingerLen, fingerBase64) {
  if (isIE) {
...
function VerifyFingerAllBase64() {
  if (isIE) {
