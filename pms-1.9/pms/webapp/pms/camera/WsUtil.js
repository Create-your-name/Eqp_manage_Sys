    ...
    if (aDataArray.length > 0) {
      if (aDataArray[0] == 0xef && aDataArray[1] == 0x01) {
        ...
        if (CutType == 2) {
          ...
          context.putImageData(
            imgData,
            canvas.width / 2 - ww / 2 + canvasX,
            canvas.height / 2 - hh / 2 + canvasY
          );
        ...
        for (var j = 0; j < lenJiubian; j++) {
          for (var i = 0; i < 3; i++) {
            ...
            context.moveTo(
              aDataArray[9 + i * 6 + j * 24] * 256 * aa +
                aDataArray[10 + i * 6 + j * 24] * aa +
                Xdis,
              aDataArray[12 + i * 6 + j * 24] * 256 * bb +
                aDataArray[13 + i * 6 + j * 24] * bb +
                Ydis
            );
            context.lineTo(
              aDataArray[15 + i * 6 + j * 24] * 256 * cc +
                aDataArray[16 + i * 6 + j * 24] * cc +
                Xdis,
              aDataArray[18 + i * 6 + j * 24] * 256 * dd +
                aDataArray[19 + i * 6 + j * 24] * dd +
                Ydis
            );
            context.stroke();
          }
          ...
          context.moveTo(
            aDataArray[27 + j * 24] * 256 + aDataArray[28 + j * 24] + Xdis,
            aDataArray[30 + j * 24] * 256 + aDataArray[31 + j * 24] + Ydis
          );
          context.lineTo(
            aDataArray[9 + j * 24] * 256 + aDataArray[10 + j * 24] + Xdis,
        ...
        if (isSecondDev) {
          ...
          contextSecond.putImageData(
            imgData,
            canvasSecond.width / 2 - ww / 2,
            canvasSecond.height / 2 - hh / 2
          );
          if (CutType == 2) {
            rec_ww2 = ww;
            rec_hh2 = hh;
        ...
        for (var j = 0; j < faceNum * 4; j++) {
          ...
          faceZuobiao[j * 2] =
            aDataArray[5 + j * 6] * 256 * aa + aDataArray[6 + j * 6] * aa;
          ...
          faceZuobiao[j * 2 + 1] =
            aDataArray[8 + j * 6] * 256 * bb + aDataArray[9 + j * 6] * bb;
        }
...
function sendMsgUploadFilePort(
  port,
  uploadSerHead,
  uploadSerLast,
  uploadSerFile
...
function sendMsgCombineTwoImage(
  path1Unicode,
  path2Unicode,
  path3Unicode,
  type
...
function sendMsgCombineTwoImageInside(
  path1Unicode,
  path2Unicode,
  path3Unicode,
  xoff,
...
function sendMsgCombineTwoImageInsideBase64(
  path1Unicode,
  path2Unicode,
  xoff,
  yoff
...
function GetFaceZuobiao(Xdis, Ydis) {
  if (isFaceOpen) {
    for (var j = 0; j < faceNum; j++) {
      for (var i = 0; i < 3; i++) {
        context.moveTo(
          faceZuobiao[2 * i + j * 8] + Xdis,
          faceZuobiao[2 * i + j * 8 + 1] + Ydis
        );
        context.lineTo(
          faceZuobiao[2 * i + j * 8 + 2] + Xdis,
          faceZuobiao[2 * i + j * 8 + 3] + Ydis
        );
        context.stroke();
      }

      context.moveTo(
        faceZuobiao[6 * i + j * 8] + Xdis,
        faceZuobiao[6 * i + j * 8 + 1] + Ydis
      );
      context.lineTo(
        faceZuobiao[0 + j * 8] + Xdis,
        faceZuobiao[1 + j * 8] + Ydis
      );
      context.stroke();
    }
  }
...
function GetFaceZuobiaoSecond(Xdis, Ydis) {
  if (isFaceOpenSecond) {
    ...
    for (var j = 0; j < faceNumSecond; j++) {
      for (var i = 0; i < 3; i++) {
        contextSecond.moveTo(
          faceZuobiaoSecond[2 * i + j * 8] + Xdis,
          faceZuobiaoSecond[2 * i + j * 8 + 1] + Ydis
        );
        contextSecond.lineTo(
          faceZuobiaoSecond[2 * i + j * 8 + 2] + Xdis,
          faceZuobiaoSecond[2 * i + j * 8 + 3] + Ydis
        );
        contextSecond.stroke();
      }

      contextSecond.moveTo(
        faceZuobiaoSecond[6 * i + j * 8] + Xdis,
        faceZuobiaoSecond[6 * i + j * 8 + 1] + Ydis
      );
      contextSecond.lineTo(
        faceZuobiaoSecond[0 + j * 8] + Xdis,
        faceZuobiaoSecond[1 + j * 8] + Ydis
      );
      contextSecond.stroke();
    }
  }
